...
- **Категория** внутреннего узла взвешена и постоянна: бой 51, находка 42, святилище 7.
  Конкретный вид внутри категории решает поколение округи: боевой узел — стычка (42)
  или сильный противник (9); находка — сбор (16), событие (14) или тайник (12).
...
случайных коротких троп. Каждый узел — выход в том числе — достижим от входа по самому
дереву. Связи симметричны: граф неориентированный.
