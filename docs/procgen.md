...
city_id, tier, difficulty, started_at)`; вид комнаты каждого слоя и её развилка
...
на `delve`/`grim` бросает 1–2 условия захода из `run_seed`
(`domain/rules/dungeon.py`). Подробно — `docs/dungeons.md`, ADR 0036.
