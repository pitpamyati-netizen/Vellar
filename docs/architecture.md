...
| Нигде — считается заново | скелет локации и облик её нынешнего поколения, узлы, противники, добыча, итоговые характеристики, прилавок (всё это чистые функции от сида, выработки, волны и переворота) |
