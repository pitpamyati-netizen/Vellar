...
бою впятером иначе не расслышать, кого ударили. Место в отряде стоит рядом с именем:
кого лечить, решают по нему (ADR 0025, `docs/party.md`). Там, где противник не один,
