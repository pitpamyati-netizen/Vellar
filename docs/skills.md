...
Бой. Круг 3.
Против вас:
2. Волчий вожак (эпический): здоровье 68 из 140, это 49 процентов. Намерение: напор (бьёт сильнее, но открыт — бейте мимо брони).
С вами:
3. Мирна (лекарь): здоровье 210 из 340, это 61 процент.
Вы (щит): здоровье 91 из 120, это 76 процентов, отвага 40 из 60.
След: напор. Дальше: повтор даст разгон 25 процентов; заслон даст разнобой.
