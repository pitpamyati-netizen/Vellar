...
`[city.deep_dungeon]` обязателен: у города два спуска (ADR 0028). Обычный
безымянный и берёт уровень от самой глубокой достигнутой локации; глубокий идёт
по `level_max` города, с игроком не растёт и открыт тому, кто дорос до последней
локации. Механики у него своей нет — тот же движок, только уровень выше и дно
богаче.
...
- у каждого города есть `[city.deep_dungeon]` с именем и строкой;
