...
Уточнён ADR 0050: круг взаимных контр убран — три тега (напор / заслон / финт)
стали тремя разными вещами; брешь теперь у того, кто объявил напор, а намерение
противника — постоянная повадка, а не ротация по кругу. Разнобой (бывший перелом)
остался как награда за непредсказуемость.
