...
- Карту локации перекладывает поколение округи: её двигает выработка узлов, а не
  часы. То, что стоит в узлах, приходит волнами, общими для всех, кто в локации,
  и встаёт заново через три минуты после того, как узел вычистили
- 16 рас, 8 классов, 11 ремёсел, 64 черты — всё объявлено в TOML под [`content/`](content/)
...
- Конец пути на 150-м: дерево специализации — класс ветвится трижды, вход в
  ветку оплачивают цепочкой заданий, и с веткой приходит своё боевое умение
...
| Бой | пошаговый, шесть слотов умений и расовый, две стороны в одной очереди — в одиночку или отрядом, против мира или против живых; у каждой породы своя повадка, никаких таймеров нигде |
| Город | лавка, таверна с доской заданий, наставник, банк, кузница, сводка заставы, подземелья, арена и те, кто там живёт |
| Вещи | сумка, карточка вещи со сравнением с надетым, снаряжение, собранное из рода, ступени и редкости |
| Ремёсла | пять сборов инструментом у жилы, шесть цехов, лестницы работ по рангам, качество партии, задания на сделанные вещи |
| Другие игроки | живой поединок на вольной локации (панель у обоих, ходят оба), отряд до пяти, гильдия до тридцати с казной, арена, сделки в игровой группе |
| Конец пути | дерево специализации: 112 веток на 30, 75 и 150 уровне, и дома |
...
У города список названных подземелий: несколько обычных вразброс по его полосе
и одно глубокое на её верху; сложность выбирают на входе. Что ещё не сделано —
`Roadmap.md`.
...
| [docs/skills.md](docs/skills.md) | Панель умений, ранги, повадки врагов, правила против разрастания |
| [docs/crafts.md](docs/crafts.md) | Ремёсла: цеха, ранги, сбор, рецепты и качество партии |
| [docs/dungeons.md](docs/dungeons.md) | Подземелья города, сложности, развилки и блуждающие ходы |
| [docs/progression.md](docs/progression.md) | Полоса уровней, характеристики и цена золота |
| [docs/subclasses.md](docs/subclasses.md) | Дерево специализации: ветки, испытания, умения |
| [docs/keeper.md](docs/keeper.md) | Панель смотрителя: правки поверх содержимого |
...
16 рас · 8 классов · 64 черты · 368 умений (по 24 боевых и 20 пассивных на класс
плюс 16 расовых, у каждого пять рангов) · 15 родов урона, четыре из них
физические · 23 состояния · 11 ремёсел с 467 рецептами · 40 пород противников в
пяти повадках и 10 прозвищ-модификаторов · 56 заданий пяти актов · 63 вида
снаряжения на 17 ступенях в 5 редкостях · 15 городов × 5 локаций на уровни 1–150 ·
75 подземелий · 7 великих домов · 112 веток специализации. Всё это лежит в
[`content/`](content/) как TOML и проверяется на старте: на испорченном
содержимом бот не поднимается и называет все беды разом.
