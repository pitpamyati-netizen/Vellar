...
Метрики (``mmorpg.metrics``) отвечают на вопрос «как игре живётся». На вопрос
«что случилось у этого игрока вчера вечером» они не отвечают вовсе, а именно он
...
(аккаунт заблокирован), ``ignored`` (ни один роутер не взял кнопку - для игрока
это молчание).
