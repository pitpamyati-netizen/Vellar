...
def build_location(
    ...
    *,
    ...
    (``node_rules.location_epoch``): от него зависит вся раскладка - дерево троп,
    места узлов, их имена. От места не зависит только число узлов и набор
    категорий. О самой локации не хранится ничего.
    """
