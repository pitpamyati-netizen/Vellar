...
def welcome_screen() -> Screen:
    ...
    return Screen(
        id=ScreenId.START,
        lines=(
            "Веллар — держава на одной дороге между хребтом и морем; на дороге "
            "стоят пятнадцать городов.",
            "Правят ею семь великих домов, и за опасную работу здесь платят.",
            "Вы приезжаете чужаком: без дома, без места в списках.",
