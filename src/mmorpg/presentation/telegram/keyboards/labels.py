...
SUMMARY = label("Сводка", "📋")
MENTOR = label("Наставник", "📖")
BANK = label("Банк", "💰")
# Кузница чинит надетое. Инструмент она не берёт: сточенный меняют в лавке.
FORGE = label("Кузница", "⚒")
SHOP = label("Лавка", "🛒")
...
# Испытание ветки специализации (ADR 0074): взять шаг у наставника. Сдают его
# кнопкой «Сдать задание» - это то же задание и та же сдача.
TRIAL_TAKE = label("Взяться за испытание", "🧭")
REPAIR_ALL = label("Починить всё", "🛠")
# Кузница делает с вещью не только починку: разбирает её в сырьё и перековывает
# оттиск - ведущий аффикс, имя и числа (ADR 0059, 0060).
SALVAGE = label("Разобрать вещи", "🔩")
REFORGE = label("Перековать вещь", "⚒")
