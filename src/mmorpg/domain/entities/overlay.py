...
class OverlayKind(StrEnum):
    ...
    CRAFT = "craft"
    RECIPE = "recipe"
    #: Опорные числа игры (``content.rules``): величина характеристики на старте,
    #: очки за уровень, уровней на очко умения, цена ранга. Единственная
    #: разновидность без множества сущностей — она одна, и завести вторую нельзя.
    META = "meta"
    #: Ступени нового имени (``content.rebirths``): с какого уровня просят, что
    #: ступень даёт и сколько вех уносит наследием (ADR 0070).
    TURNING = "turning"
