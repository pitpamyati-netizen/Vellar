...
#: становится больше по кривой опыта, и плата, растущая вровень с уровнем, к
#: концу полосы давала за один уровень в полсотни раз больше, чем стоила вещь
#: своей ступени. Показатель ниже единицы держит одну и ту же меру по всей
#: полосе: за уровень набирается примерно полторы вещи своей ступени - что на
#: первом уровне, что на сто пятидесятом.
GOLD_BASE = 4.0
GOLD_PER_LEVEL = 3.5
GOLD_EXPONENT = 0.55
