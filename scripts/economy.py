...
пошлина, ставка круга и цена боя, — были записаны догадками, и первая их правка
должна опираться на сутки живой игры, а не на ощущение (Roadmap, «Риски»).
"""
...
NAMES = {
    ...
    "descent": "дно спуска",
    "quest": "подряды",
    "arena_payout": "выплаты круга",
    "arena_stake": "ставки круга",
    "duel": "поединки",
