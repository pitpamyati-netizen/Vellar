...
``pledges`` — что уже ушло в перерождения. Без этого списка грань, выбираемую
бесплатно, можно было бы заложить и выбрать заново, и Печати печатались бы из
воздуха.

Существующие персонажи начинают с нуля Печатей: перерождение совершают руками, задним
